...
const LessonGroupDetails: React.FC<LessonGroupDetailsProps> = ({
  groupName,
  absentStudents,
  totalStudents,
}) => {
  ...
  return (
    <div className="border border-gray-300 rounded p-4 mb-6">
      <div className="mb-4 flex items-center">
        ...
        <span className="text-xl text-accent md:text-2xl font-semibold">
          Group: {groupName}
        </span>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-x-4 gap-y-2">
        ...
        <p className="flex items-center">
          <span className="font-medium text-green-600 mr-2">Present: </span>
          {presentStudents} students
        </p>
        <p className="flex items-center">
          <span className="font-medium text-red-600 mr-2">Absent: </span>
